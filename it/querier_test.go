...
func init() {
	...
	fmt.Println(db.Execute(Drop))
	fmt.Println(db.Execute(Create))
}
...
func TestInsert(t *testing.T) {
	Convey("写入测试", t, func() {
		Convey("正常", func() {
			...
			So(g1.Blessing, ShouldEqual, g0.Blessing)
...
func TestUpdate(t *testing.T) {
	Convey("更新测试", t, func() {
		Convey("正常", func() {
			...
			So(g2.Blessing, ShouldEqual, g1.Blessing)
...
func newEnvelopeGoods(seed int) EnvelopeGoods {
	...
	g := EnvelopeGoods{
		...
		Blessing:     "test-blessing" + deedStr,
