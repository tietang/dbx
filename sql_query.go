...
type mapperExecutor interface {
    ...
    Get(out interface{}, sql string, params ...interface{}) (err error)
    GetContext(ctx context.Context, out interface{}, sql string, params ...interface{}) (err error)
    GetOne(out interface{}) (err error)
    GetOneContext(ctx context.Context, out interface{}) (err error)
}
